...
# The new full-resolution RGB head is initialized on the completed
# C32/GWC4/enc16 gated-GRU3 checkpoint; the recurrent base stays frozen.
BASE_CKPT="${BASE_CKPT:-checkpoints/defom_pivno_gated_gru3_gwc4gate_enc16_noleft_rgb_d768_320x768_b4_2gpu_200k.pth}"
NAME="${NAME:-defom_pivno_gated_gru3_gwc4_mask_rgb_sr_head_d768_20k}"
...
echo "Completed C32/GWC4 gated-GRU3 mask/RGB-guided SR launch"
echo "  base=${BASE_CKPT}"
echo "  name=${NAME} stage=head trainable=sr_head.* feature=full-resolution-left-RGB"
