...
class BasicMultiUpdateBlock(nn.Module):
    def __init__(self, args, hidden_dims=[128, 128, 128], dim = 1):
        ...
        self.gru08 = ConvGRU(hidden_dims[2], encoder_output_dim + hidden_dims[1] * (args.n_gru_layers > 1), 1)
        self.gru16 = ConvGRU(hidden_dims[1], hidden_dims[0] * (args.n_gru_layers == 3) + hidden_dims[2], 1)
        self.gru32 = ConvGRU(hidden_dims[0], hidden_dims[1], 1)
